    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">Some content still processing; you may refresh the graph manually later.</span>
...
const wasSimulating = ref(false) // track if we were simulating before
...
// Watch isSimulating; show hint when simulation ends
...
const renderGraph = () => {
  ...
  tempEdges.forEach(e => {
    ...
    if (isSelfLoop) {
      // self-loop: one merged self-loop per node
      ...
      edges.push({
        ...
        rawData: {
          ...
          selfLoopEdges: allSelfLoops // full self-loop edge details
        }
      })
      return
    }
  ...
  // Simulation: adjust node spacing by edge count
