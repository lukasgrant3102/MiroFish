    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are chunked and Zep is used to build the knowledge graph, extract entities and relations, and form temporal memory and community summaries.
          </p>
